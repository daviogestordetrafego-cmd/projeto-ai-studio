...
const BestSellers: React.FC<BestSellersProps> = ({ addToCart }) => {
  ...
  return (
    <section className="py-24 bg-white overflow-hidden border-b border-soft-lilac/30">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="animate-fade-in-up">
            <h2 className="serif-title text-5xl md:text-6xl text-primary mb-4">Fluxo de Energia Vibracional</h2>
            <div className="w-24 h-1 bg-accent rounded-full mb-6"></div>
            <p className="text-gray-500 text-lg font-light">Explore a ressonância de nossas coleções curadas para o seu despertar.</p>
          </div>
        ...
        >
          ...
          <div className="min-w-[280px] md:min-w-[320px] flex items-center justify-center snap-start">
             ...
             >
                ...
                <span className="serif-title text-2xl text-primary">Ver Mais Coleções</span>
             </Link>
          </div>
        </div>
      </div>
